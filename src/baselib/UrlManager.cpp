...
std::string UrlManager::getReportVideolistUrl(){
	return getBaseUrl() + "api/ad/report";
}

std::string UrlManager::getConfigSuccessUrl(){
	return getBaseUrl() + "api/config/success";
}
