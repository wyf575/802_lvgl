...
namespace JsonParse{
	...
	std::string buildCmdResponse(int cmd, std::string curCmd_Id, std::string state, bool isResult);
	string buildCmdResponse(int cmd, std::string curCmd_Id, int current, int total, std::string state, bool isResult);
