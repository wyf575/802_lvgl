...
void DeviceSigManager::updateSigUI(lv_obj_t* sigView){
	S_NetSig* s_netSig = getNetSignal();
	LOGD("----updateSigUI---%d\n", sigView);
	switch(s_netSig->sigType){
		case NETWORKTYPE_ETHERNET:
			ui_set_obj_background_pic(sigView, "sig/stat_sys_eth_connected.png");
		break;
		case NETWORKTYPE_4G:
			LOGD("----updateSigUI---NETWORKTYPE_4G %d\n", s_netSig->sig);
			if(s_netSig->sig < 2){
				ui_set_obj_background_pic(sigView, "sig/sig_4g_0.png");
			}else if(s_netSig->sig == 99){
				ui_set_obj_background_pic(sigView,"sig/no_sig.png");
			}else{
				int level = s_netSig->sig / 7;
				switch (level) {
					case 0:
						ui_set_obj_background_pic(sigView, "sig/sig_4g_1.png");
						break;
					case 1:
						ui_set_obj_background_pic(sigView, "sig/sig_4g_2.png");
						break;
					case 2:
						ui_set_obj_background_pic(sigView, "sig/sig_4g_3.png");
						break;
					case 3:
						ui_set_obj_background_pic(sigView, "sig/sig_4g_4.png");
						break;
					default:
						break;
				}
		...
		case NETWORKTYPE_WIFI:
			...
			switch (level) {
				case 0:
					ui_set_obj_background_pic(sigView, "sig/sig_wifi_0.png");
					break;
				case 1:
					ui_set_obj_background_pic(sigView, "sig/sig_wifi_1.png");
					break;
				case 2:
					ui_set_obj_background_pic(sigView, "sig/sig_wifi_2.png");
					break;
				case 3:
					ui_set_obj_background_pic(sigView, "sig/sig_wifi_3.png");
					break;
				case 4:
					ui_set_obj_background_pic(sigView, "sig/sig_wifi_4.png");
					break;
				default:
					break;
			}
