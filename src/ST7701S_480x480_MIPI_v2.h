...
#define HFP				80
#define HACTIVE		480
#define HTOTAL  	(HACTIVE+HPSW+HBP+HFP)
#define VPSW			2
#define VBP				30
#define VFP				18
#define VACTIVE		480
#define VTOTAL 		(VACTIVE+VPSW+VBP+VFP)

#define CLK				(HTOTAL*VTOTAL*60/1000000+1)
MI_PANEL_ParamConfig_t stPanelParam =
{
    "ST7701S__480x480_60", // const char *m_pPanelName;                ///<  PanelName
    ...
    3,  //MS_U8 m_ucPanelDCKLCurrent;              ///<  define PANEL_DCLK_CURRENT
    3,  //MS_U8 m_ucPanelDECurrent;                ///<  define PANEL_DE_CURRENT
    3,  //MS_U8 m_ucPanelODDDataCurrent;           ///<  define PANEL_ODD_DATA_CURRENT
    3,  //MS_U8 m_ucPanelEvenDataCurrent;          ///<  define PANEL_EVEN_DATA_CURRENT
    ...
    HACTIVE,  //MS_U16 m_wPanelWidth;                    ///< PANEL_WIDTH, DE width (VOP_05[11:0] = HEnd = HStart + Width - 1)
    VACTIVE,  //MS_U16 m_wPanelHeight;                   ///< PANEL_HEIGHT, DE height (VOP_07[11:0], = Vend = VStart + Height - 1)
...
MI_PANEL_MipiDsiConfig_t stMipiDsiConfig =
{
    ...
    HACTIVE,   HPSW, HBP,  HFP,  VACTIVE, VPSW, VBP, VFP,   0,    60,

    E_MI_PNL_MIPI_DSI_LANE_2,      // MIPnlMipiDsiLaneMode_e enLaneNum;
    E_MI_PNL_MIPI_DSI_RGB888, //E_MI_PNL_MIPI_DSI_RGB565     // MIPnlMipiDsiFormat_e enFormat;
