...
#define PANEL_CONFIG_FILE	"panel.ini"
...
void GetPanelSetting(void)
{
	...
	printf("g_PanelWidth: %d, g_PanelHeight: %d, g_RotateSetting: %d, g_UIWidth: %d, g_UIHeight: %d\n",g_PanelWidth,g_PanelHeight,g_RotateSetting,g_UIWidth,g_UIHeight);
